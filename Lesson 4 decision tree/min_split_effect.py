...
acc_min_samples_split_2 = clf_min_samples_split_2.score(features_test, labels_test)

#second classifier with min_split =50
...
acc_min_samples_split_50 = clf_min_samples_split_50.score(features_test, labels_test)
